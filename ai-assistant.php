...
export function AIAssistantImproved() {
  ...
  const getAIResponse = (input: string) => {
    ...
    if (lowerInput.includes("each device") || lowerInput.includes("separately")) {
      ...
      lowerInput.includes("compnay network")
    ) {
      ...
      return "I'm here to help with your IT systems. Feel free to ask about system monitoring, deployments, or any technical issues you're facing."
    } else {
